...
A Process Care Services Resources Request Message is a FHIR batch/transaction operation including Care Services resources the Care Services Feed Consumer supports.    Each entry in the bundle SHALL conform to the other feed request messages:
