...
A Care Services Feed Consumer SHALL process the submission to validate the resources submitted, and give a response as per [Section 2:3.130.4.2](#2313042-create-care-services-resources-response-message) or an error as per [{{site.data.fhir.path}}http.html#create]({{site.data.fhir.path}}http.html#create).
...
A Care Services Feed Consumer SHALL process the submission to validate the resources submitted, and give a response as per [Section 2:3.130.4.3](#2313044-update-care-services-resources-response-message) or an error as per [{{site.data.fhir.path}}http.html#update]({{site.data.fhir.path}}http.html#update).
...
A Care Services Feed Consumer SHALL process the submission and give a response as per [Section 2:3.130.4.5](#2313046-delete-care-services-resources-response-message) or an error as per [{{site.data.fhir.path}}http.html#delete]({{site.data.fhir.path}}http.html#delete).
...
A Care Services Feed Consumer SHALL process the submission and give a response as per [Section 2:3.130.4.7](#2313048-process-care-services-resources-response-message) or an error as per [{{site.data.fhir.path}}http.html#transaction]({{site.data.fhir.path}}http.html#transaction).
...
* [Create Care Services Resource](#2313041-create-care-services-resources-request-message)
* [Update Care Services Resource](#2313043-update-care-services-resources-request-message)
* [Delete Care Services Resource](#2313045-delete-care-services-resources-request-message)
