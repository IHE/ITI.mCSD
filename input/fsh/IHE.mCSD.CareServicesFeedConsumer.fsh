Instance: IHE.mCSD.CareServicesFeedConsumer
InstanceOf: CapabilityStatement
Usage: #definition
* version = "20250218"
* name = "IHE_mCSD_Care_Services_Feed_Consumer"
* title = "IHE ITI Mobile Care Services Discovery (mCSD) - Care Services Feed Consumer"
* status = #active
* experimental = false
* date = "2025-02-18"
* description = "CapabilityStatement for Care Services Feed Consumer Actor in the IHE IT Infrastructure Technical Framework Supplement IHE mCSD."
* kind = #requirements
* fhirVersion = #4.0.1
