Instance: IHE.mCSD.QueryClient
InstanceOf: CapabilityStatement
Usage: #definition
* version = "20250218"
* name = "IHE_mCSD_Query_Client"
* title = "IHE ITI Mobile Care Services Discovery (mCSD) - Query Client"
* status = #active
* experimental = false
* date = "2025-02-18"
* description = "CapabilityStatement for Query Client Actor in the IHE IT Infrastructure Technical Framework Supplement IHE mCSD."
* kind = #requirements
* fhirVersion = #4.0.1
