Instance: IHE.mCSD.CareServicesUpdateSupplier
InstanceOf: CapabilityStatement
Usage: #definition
* version = "20250218"
* name = "IHE_mCSD_Care_Services_Update_Supplier"
* title = "IHE ITI Mobile Care Services Discovery (mCSD) - Care Services Update Supplier"
* status = #active
* experimental = false
* date = "2025-02-18"
* description = "CapabilityStatement for Care Services Update Supplier Actor in the IHE IT Infrastructure Technical Framework Supplement IHE mCSD."
* kind = #requirements
* fhirVersion = #4.0.1
